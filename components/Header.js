        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href={user ? '/account' : '/login'} aria-label="Личный кабинет"
                className="w-9 h-9 rounded-lg flex items-center justify-center hover:bg-teal-50 transition-colors">
