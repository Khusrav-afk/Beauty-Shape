...
export async function generateMetadata({ params }) {
  ...
  return { title: cat ? `${cat.name} — Beauty Shape` : 'Каталог' }
}
    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="mt-12 p-6 rounded-2xl text-center" style={{background:'#f0fdfb'}}>
          ...
          <p className="text-sm text-gray-500 mb-4">Расскажите о ваших задачах — подберём оптимальный аппарат</p>
          <Link href="/contacts"
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-0.5 group">
      ...
      <div className="p-4">
        ...
        <Link href={`/catalog/${product.categorySlug}/${product.slug}`}
          className="mt-3 block w-full py-2.5 rounded-xl text-center text-sm font-semibold text-white transition-all hover:opacity-90"
