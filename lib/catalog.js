// Категории которым нужно платное обучение (Вариант Б)
...
export const products = [
  // HIFU SMAS
  { id: 1,  slug: 'hifu-smas-system',     categorySlug: 'hifu-smas',      country: 'CN', name: 'HIFU SMAS SYSTEM',                    price: 100000, priceFrom: true,  stock: 3,  isHit: true,  desc: 'Профессиональный аппарат HIFU SMAS лифтинга. Подтяжка лица и тела без операций. Гарантия 1 год.',  specs: { 'Тип': 'Ультразвуковой лифтинг', 'Картриджи': '4 шт в комплекте', 'Экран': '10 дюймов', 'Гарантия': '1 год' } },
  { id: 2,  slug: 'hifu-smas-system-pro', categorySlug: 'hifu-smas',      country: 'CN', name: 'HIFU SMAS SYSTEM PRO',                price: 150000, priceFrom: true,  stock: 2,  isHit: true,  desc: 'Профессиональная версия с держателями манипулы и гелем.', specs: { 'Тип': 'Ультразвуковой лифтинг', 'Картриджи': '6 шт в комплекте', 'Гарантия': '1 год' } },
  { id: 3,  slug: 'hifu-smas-mini',       categorySlug: 'hifu-smas',      country: 'CN', name: 'HIFU SMAS Mini',                      price: 75000,  priceFrom: false, stock: 5,  isHit: false, desc: 'Портативный аппарат HIFU SMAS. Удобен для работы на дому и в небольших кабинетах.', specs: { 'Тип': 'Портативный', 'Вес': '3 кг', 'Гарантия': '1 год' } },
  { id: 4,  slug: 'hifu-7d-ultramage',    categorySlug: 'hifu-smas',      country: 'CN', name: 'HIFU SMAS 7D ULTRAMAGE',              price: 160000, priceFrom: false, stock: 2,  isHit: true,  desc: '7D HIFU с двумя манипулами. Мощный аппарат для глубокого лифтинга.', specs: { 'Линии': '7D', 'Манипулы': '2 шт', 'Гарантия': '1 год' } },
  { id: 5,  slug: 'hifu-7d-station',      categorySlug: 'hifu-smas',      country: 'CN', name: 'Стационарный HIFU 7D SYSTEM',         price: 150000, priceFrom: true,  stock: 1,  isHit: false, desc: 'Стационарная версия HIFU 7D.', specs: { 'Тип': 'Стационарный', 'Гарантия': '1 год' } },
  { id: 6,  slug: 'hifu-7d-mpt',          categorySlug: 'hifu-smas',      country: 'CN', name: 'Стационарный HIFU 7D MPT',            price: 250000, priceFrom: true,  stock: 1,  isHit: false, desc: 'Топовая стационарная версия 7D с MPT технологией.', specs: { 'Технология': 'MPT', 'Гарантия': '1 год' } },
...
export function needsPaidTraining(product) {
  return PAID_TRAINING_CATEGORIES.includes(product.categorySlug)
}
