...
// COUNTRY_FLAG_SRC удалён: флаги теперь рисуются встроенным SVG (components/CountryFlag.js), без внешних CDN
...
// Уменьшает и сжимает Cloudinary-картинку на лету (f_auto,q_auto,w_N),
// чтобы не грузить многомегабайтные оригиналы на мобильных сетях.
